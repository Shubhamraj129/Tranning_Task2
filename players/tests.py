...
class Test_school(APITestCase):
    # @classmethod
    def setUp(self):
        data = {'password': 'see22W@', 'email': 'fgi2@gmail.com', 'is_superuser': '1', 'state': 'maratxxehoner',
...
class TestUser_login(APITestCase):
    ...
    def setUp(self):
        data = {'password': 'hgt@', 'email': 'fi2@gmail.com', 'is_superuser': '1', 'state': 'mxxehoner',
        ...
        response = self.client.post(
            ...
            data,
            format="json")
        # self.client.login(username="Adlad", email="fi2@gmail.com", password='hgt@')
